...
public class VirtualPieceField : MonoBehaviour
{
    [SerializeField] private Pieces piece;
    [SerializeField] private Players color;
    [SerializeField] private VirtualBoardPosition virtualBoardPosition;
    ...
    public VirtualPieceField(Players color, int row, int column)
    {
        this.color = color;
        this.row = row;
        this.column = column;
    ...
    public VirtualBoardPosition GetVirtualBoardPosition()
    {
        return virtualBoardPosition;
    }
    ...
    public PieceField VirtualMovableSpaceCheck(Direction direction)
    {
        switch (direction)
        {
